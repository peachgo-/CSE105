...
%% indent for description environment. 支持多行对齐
% \renewenvironment{description}[1]{
%     \begin{list}{}{%
%             \renewcommand{\makelabel}[1]{\bfseries{##1}\hfil}%
%             \setlength{\leftmargin}{10pt}% 缩进10
...
\newcommand{\NFST}{{ M = \lst{Q,\Sigma,\Gamma,\delta,s,F} }}
% \newcommand{\reducable}[2]{#1 \le_{\text{\upshape FST}} #2}
